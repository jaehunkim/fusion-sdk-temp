...
describe('Auction Suffix', () => {
    ...
    it('should create suffix with specified taker fee', () => {
        ...
        expect(suffix.build()).toBe('000c004e200000000000000000219ab540356cbb839cbe05303d7705fa63c0566a00000000000000000000006400000000219ab540356cbb839cbe05303d7705fa89');
    });
    ...
    it('should decode auction suffix with taker fee', () => {
        const encodedSuffix = '000c004e200000000000000000219ab540356cbb839cbe05303d7705fa63c0566a00000000000000000000006400000000219ab540356cbb839cbe05303d7705fa89'.toLowerCase();
        const suffix = auction_suffix_1.AuctionSuffix.decode(encodedSuffix);
        expect(suffix.build()).toBe(encodedSuffix);
    });
});
